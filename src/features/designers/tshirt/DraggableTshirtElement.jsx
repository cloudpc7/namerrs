/**
 * DraggableTshirtElement.jsx — Draggable text or image on the shirt print area.
 */

import { useRef } from 'react';
import { TEXT_FIELDS } from './constants';

const DraggableTshirtElement = ({
  element,
  textColor,
  isSelected,
  onSelect,
  ...
  const handlePointerMove = (event) => {
    ...
    const canvas = event.currentTarget.closest('[data-tshirt-canvas]');
    if (!canvas) {
      return;
    }
...
export default DraggableTshirtElement;